...
public class SelectFromDDList {
	...
	public void test1() throws MalformedURLException, InterruptedException {
        ...
        AndroidElement colorsList = driver.findElement(By.xpath("//android.widget.Spinner[@resource-id='io.appium.android.apis:id/spinner1']"));
        colorsList.click();
        Thread.sleep(2000);
        
        AndroidElement greenColor = driver.findElement(By.xpath("//android.widget.CheckedTextView[@text='green']"));
        greenColor.click();
        Thread.sleep(2000);
