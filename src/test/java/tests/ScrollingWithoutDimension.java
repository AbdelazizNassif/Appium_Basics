...
public class ScrollingWithoutDimension {
	...
	public void test1() throws MalformedURLException, InterruptedException {
        ...
        driver.findElement(MobileBy.AndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true)"
				+ ".instance(0)).scrollIntoView(new UiSelector().textMatches(\"" + "Visibility" + "\").instance(0))"));
        Thread.sleep(5000);
        
        AndroidElement VisibilityButton = driver.findElement(By.xpath("//android.widget.TextView[@text='Visibility']"));
